    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TblShippingDetail", x => x.ShippingDetailId);
                    table.ForeignKey(
                        name: "FK_TblShippingDetail_TblMembers_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TblShippingDetail_MemberId",
                table: "TblShippingDetail",
                column: "MemberId");
        }
